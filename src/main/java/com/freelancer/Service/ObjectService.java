...
public class ObjectService {
    ...
    public List<ProjectDetail> getOpenProjects(long userId) {
        String query = "select c.name,sub1.* from (select a.id,a.freelancer_id,a.employer_id,a.title,a.main_skill_id,a.budget_range," +
                ...
                "join bid b on a.id=b.project_id group by a.id,a.freelancer_id,a.employer_id,a.title,a.main_skill_id,a.budget_range,a.budget_period) " +
                "as sub1,user c where c.id=sub1.employer_id and employer_id!=" + userId + " and sub1.freelancer_id IS NULL";
        ...
        for (Object obj[] : results) {
            ...
            projectDetail.setFreelancerId(obj[2] != null ? Long.parseLong(obj[2] + "") : null);
    ...
    public List<ProjectDetail> getProjectDetail(long projectId) {
        String query = "select sub1.*,b.link from (select a.id,a.freelancer_id,a.document_id,a.description,a.employer_id,a.title" +
                ...
                "as count from project a left outer join bid b on a.id=b.project_id group by a.id,a.freelancer_id,a.document_id,a.description,a.employer_id,a.title,a.main_skill_id,a.budget_range,a.budget_period) as sub1,attachments " +
        ...
        for (Object obj[] : results) {
            ...
            projectDetail.setFreelancerId(obj[1] != null ? Long.parseLong(obj[1] + "") : null);
    ...
    public List<ProjectDetail> getUserOpenProjects(long userId) {
        String query = "select a.id,a.employer_id,a.title,a.budget_range,a.budget_period,COALESCE(avg(b.bid_amount),0) as average ," +
                ...
                "where a.employer_id=" + userId + " and a.freelancer_id is NULL group by a.id,a.employer_id,a.title,a.budget_range,a.budget_period";
        List<Object[]> results = em.createNativeQuery(query).getResultList();
        List<ProjectDetail> processedResults = new ArrayList<>();
        for (Object obj[] : results) {
            ProjectDetail projectDetail = new ProjectDetail();
    ...
    public List<ProjectDetail> getUserProgressProjects(long userId) {
        String query = "select c.name,sub1.* from (select a.id as project_id,a.employer_id,a.freelancer_id,a.title,a.end_date,b.bid_amount," +
                ...
                "on a.id=b.project_id where b.bid_status!='BID_SENT' and a.employer_id=" + userId + " group by a.id,a.employer_id,a.freelancer_id,a.title,a.end_date,b.bid_amount) " +
    ...
    public List<ProjectDetail> getUserBidProjects(long userId) {
        String query = "select c.name,sub1.* from (" +
                "select a.id,a.employer_id,a.title,a.main_skill_id,a.budget_range,a.budget_period," +
                "b.bid_amount,b.bid_status,b.user_id,COALESCE(avg(b.bid_amount),0) as average ,count(b.project_id) as count " +
                "from project a left outer join bid b on a.id=b.project_id " +
                "group by a.id,a.employer_id,a.title,a.main_skill_id,a.budget_range,a.budget_period,b.bid_amount,b.bid_status,b.user_id" +
                ") as sub1,user c where c.id=sub1.employer_id and sub1.employer_id!=" + userId + " and sub1.user_id=" + userId;
        List<Object[]> results = em.createNativeQuery(query).getResultList();
        List<ProjectDetail> processedResults = new ArrayList<>();
        for (Object obj[] : results) {
            ProjectDetail projectDetail = new ProjectDetail();
